# sparv-sbx-ner-hf-kb-ner

[![PyPI version](https://badge.fury.io/py/sparv-sbx-ner-hf-kb-ner.svg)](https://pypi.org/project/sparv-sbx-ner-hf-kb-ner)
![PyPI - Python Version](https://img.shields.io/pypi/pyversions/sparv-sbx-ner-hf-kb-ner)
[![PyPI - Downloads](https://img.shields.io/pypi/dm/sparv-sbx-ner-hf-kb-ner)](https://pypi.org/project/sparv-sbx-ner-hf-kb-ner/)

[![Maturity badge - level 2](https://img.shields.io/badge/Maturity-Level%202%20--%20First%20Release-yellowgreen.svg)](https://github.com/spraakbanken/getting-started/blob/main/scorecard.md)
[![Stage](https://img.shields.io/pypi/status/sparv-sbx-ner-hf-kb-ner)](https://pypi.org/project/sparv-sbx-ner-hf-kb-ner/)

[![CI(release)](https://github.com/spraakbanken/sparv-sbx-ner/actions/workflows/release-hf-kb-ner.yml/badge.svg)](https://github.com/spraakbanken/sparv-sbx-ner/actions/workflows/release-hf-kb-ner.yml)
...
Then install install `sparv-sbx-ner-hf-kb-ner` with

```bash
pipx inject sparv-pipeline sparv-sbx-ner-hf-kb-ner
```
...
xml_export:
    annotations:
        - <token>:sbx_word_prediction_kb_bert.ner--hf-kb-ner
```
